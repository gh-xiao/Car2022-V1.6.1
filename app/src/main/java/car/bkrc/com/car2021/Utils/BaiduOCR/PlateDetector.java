package car.bkrc.com.car2021.Utils.BaiduOCR;

import static car.bkrc.com.car2021.Utils.ColorHSV.PlateDetector_HSV_VALUE_HIGH;
import static car.bkrc.com.car2021.Utils.ColorHSV.PlateDetector_HSV_VALUE_LOW;
...
//                        String baiduOCR_str = doOcr(threshold_bitmap, "eng");
                        ...
                        String baiduOCR_str = FirstActivity.Connect_Transport.plate(threshold_bitmap);
...
//                                result_str = plateString(baiduOCR_str);
    ...
    private String plateString(String plateResult) {
        ...
        try {
            ...
            strBuilder = plateReplace(strBuilder);
            /* 输出结果 */
