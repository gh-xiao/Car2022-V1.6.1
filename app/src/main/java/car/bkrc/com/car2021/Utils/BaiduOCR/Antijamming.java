...
import car.bkrc.com.car2021.Utils.RGB2HSV;
...
public class Antijamming {
    //红、绿、蓝、黄、品、青、黑色个数
    private static int[] colorNum = new int[8];
    //黑色最大RGB值和
    private static int blackMax = 255;
    //红绿蓝最大RGB值和
    private static int RGBMax = 365;
    //黄品青最大RGB值和
    private static int noiseMax = 510;
    //HSV数组
